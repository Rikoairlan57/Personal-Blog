...
const portfolios = [
  {
    ...
    description: "Working as React and Node Js",
...
const socialLinks = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/rikoairlanramadhan",
    icon: (props: any) => (
  ...
  {
    name: "Youtube",
    href: "https://www.youtube.com/Kirin",
    icon: (props: any) => (
  ...
  {
    name: "Twitter",
    href: "https://twitter.com/rikoairlan",
    icon: (props: any) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
